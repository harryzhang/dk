...
<div class="bottom" style="margin:0;">
  ...
  <div class="bottom_one">
    <div class="bottom_one_all">
      ...
      <div class="bottom_logo"> <img src="<c:url value='web_res/img/er_wema.jpg'/>"  width="142" height="142" /> </div>
      ...
      <div class="bottom_logo" style=" margin-right:35px;"> 
        ...
        <%--				<a href="http://webscan.360.cn/index/checkwebsite/url/www.hehenian.com" target="right">--%>
             ...
             <p style="float:left; margin-top:15px;"><a class="ui-footer-img-link weibo" href="http://weibo.com/u/3893072293" target="_blank">合和年新浪微博</a></p>
              <p style="float:left; margin-top:15px;"><a class="ui-footer-img-link we-chat" href="<c:url value='web_res/img/er_wema.jpg'/>"  rel="lytebox" title="请扫描二维码，添加微信账号<br />
...
<!--底部footer 结束--> 
<script type="text/javascript" src="<c:url value='web_res/js/jqueryV172.js'/>"></script>
<script type="text/javascript" src="<c:url value='web_res/js/xl.js'/>"></script>
...
@font-face{font-family:"Merriweather";src:url("<c:url value='/web_res/font/Merriweather.ttf'/>");}


#rightButton{ position:fixed; _position:absolute; top:208px; right:0; z-index:999999; display:block;}
#right_ul{ position:relative;}
#right_qq{  background:url(<c:url value='web_res/img/7_03.png'/>) no-repeat; width:38px; height:41px; }
#right_tel{ background:url(<c:url value='web_res/img/7_05.png'/>) no-repeat; width:38px; height:41px; }
#right_tip{  background:url(<c:url value='web_res/img/flag_right.png'/>) no-repeat; width:252px; height:91px; position:absolute; right:40px; top:-10px; display:none; z-index:999999; }
...
a.backToTop_a{  background:url(<c:url value='web_res/img/7_08.png'/>) no-repeat; width:38px; height:44px; display:block; }
a.backToTop_a:active{  background:url(<c:url value='web_res/img/7_11.png'/>) no-repeat; }
