...
import com.shove.util.httpClient.HttpProtocolHandler;
import com.shove.util.httpClient.HttpRequest;
import com.shove.util.httpClient.HttpResponse;
import com.shove.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
	private static Log log = LogFactory.getLog(AlipaySubmit.class);
    /**
     * 生成要请求给支付宝的参数数组
