...
<body style='font-family:微软雅黑; text-align: left;font-size:12px;'>
	...
	<p>2、乙方按期向甲、丙、丁三方支付本合同项下的借款本金、利息、手续费等其他的相关费用，乙方可采取如下的还款方式进行还款：</p>
	...
	<p>2、丁方有权就为本合同项下借款所提供的服务向乙方收取手续费：手续费一次性收取，按借款金额的${(borrow["feeRate"])!''}%计算，
		本次借款的手续费为人民币（大写）：<u>${(borrow["feeAmtCn"])!''}</u>，（小写）：￥<u>${(borrow["feeAmt"])!''}</u>元。在第一个月的还款日收取，若还款账户内余额不足时，首先冲抵手续费。</p>
	...
	<p>4、如果乙方逾期支付任何一期还款超过30天，或连续逾期三期以上（含三期），或累计逾期达五期以上（含五期），或乙方在逾期后出现逃避、拒绝沟通或拒绝承认欠款事实等恶意行为，可认定为本协议项下
		的全部借款本息提前到期，乙方应立即清偿本协议下尚未偿付的全部本金、利息、咨询费、逾期罚息、手续费及根据本协议产生的其他全部费用。</p>
