...
<body style='font-family:微软雅黑; text-align: left;font-size:12px;'>
	...
	<p>5、丙方是一家在广东省深圳市合法成立并有效存续的有限责任公司；负责为甲乙双方报告订立合同的机会、
	负责审查乙方的借款申请及相关文件，对乙方是否具备还款能力等情况进行判断、负责本合同项下借款的日常管理工作，
	并依据与乙方的约定代乙方对甲方的贷款进行代偿。</p>
	...
	乙方除须还清截至还款当日为止的剩余本金及当期应还利息、手续费、咨询费（含逾期产生的所有滞纳金代偿费用）之外，
	还须向丙方支付提前结清违约金。因提前清偿所产生的提前结清违约金由乙丙双方另行决定，与甲方无关。</p>
