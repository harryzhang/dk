...
<body style='font-family:微软雅黑; text-align: left;font-size:12px;'>
	...
	<p>7、如乙方还款不足以偿还约定本金、利息及违约金的，各方均同意按照逾期罚息、提前结清违约金、咨询费、利息、本金的顺序冲销还款。</p>
	<p><b>(二)<u>乙方权利和义务</u></b></p>
	<p>1、乙方必须按期足额向甲方支付每期应还本金和利息。</p>
	<p>2、乙方按期向甲、丙、丁三方支付本合同项下的借款本金、利息等其他的相关费用，乙方可采取如下的还款方式进行还款：</p>
	...
	<p>2、丁方应对甲方和乙方的信息及本协议内容保密；如任何一方违约，或因相关权力部门要求（包括但不限于法院、仲裁机构、金融监管机构等），丁方有权披露。</p>
	<p><b>第三条违约责任</b></p>
	<p>1、合同各方均应严格履行合同义务，非经各方协商一致或依照本协议约定，任何一方不得解除本协议。</p>
	<p>2、任何一方违约，违约方应承担因违约使得其他各方产生的费用和损失，包括但不限于调查、诉讼费、律师费等，应由违约方承担。如违约方为乙方，甲方或丙方有权立即解除本协议，
		并要求乙方立即偿还未偿还的本金、利息、咨询费、逾期罚息、违约金等费用。</p>
	<p>如本协议提前解除时，乙方在网站的账户里有任何余款，丁方有权按照本协议第三条第3项的清偿
		顺序将乙方的余款用于清偿，并要求乙方支付因此产生的相关费用。</p>
	...
	<p>（4）本协议项下借款的利息；</p>
	<p>（5）借款本金。</p>
	<p>4、如果乙方逾期支付任何一期还款超过30天，或连续逾期三期以上（含三期），或累计逾期达五期以上（含五期），或乙方在逾期后出现逃避、拒绝沟通或拒绝承认欠款事实等恶意行为，可认定为本协议项下
		的全部借款本息提前到期，乙方应立即清偿本协议下尚未偿付的全部本金、利息、咨询费、逾期罚息及根据本协议产生的其他全部费用。</p>
	<p>5、如果乙方逾期支付任何一期还款超过30天，或连续逾期三期以上（含三期），或累计逾期达五期以上（含五期），或乙方在逾期后出现逃避、拒绝沟通或拒绝承认欠款事实等恶意行为，丁方有权将乙方的“
		逾期记录”记入丁方的“信用信息库”，丁方不承担任何法律责任。</p>
	<p>6、如果乙方逾期支付任何一期还款超过30天，或连续逾期三期以上（含三期），或累计逾期达五期以上
		（含五期），或乙方在逾期后出现逃避、拒绝沟通或拒绝承认欠款事实等恶意行为，丁方有权将乙方违约失信的相关信息及乙方其他信息向媒体、用人单位、公安机关、检查机关
		、法律机关披露，丁方不承担任何责任。</p>
	<p>7、本借款协议中的所有甲方与乙方之间的借款均是相互独立的，一旦乙方逾期未归还借款本息，任何一个甲方有权单独向乙方追
		索或者提起诉讼。如乙方提供虚假信息的，丁方亦可单独向乙方追索或者提起诉讼。</p>
	<p><b>第五条 提前还款</b></p>
	<p>1、自借款起始日三个月内，甲方不接受乙方提前偿还剩余借款。</p>
	<p>2、提前偿还全部剩余借款</p>
	<p>乙方提前清偿全部剩余借款时，如乙方提前清偿的要求得到甲方允许时，甲方委托丙方代为处理提前偿还全部剩余借款的相关事项，
		乙方除须还清截至还款当日为止的剩余本金及当期应还利息、咨询费（含逾期产生的所有滞纳金代偿费用）之外，还须向丙方支付提前结清违约金。
		因提前清偿所产生的提前结清违约金由乙丙双方另行决定，与甲方无关。</p>
	<p>3、出借人不接受部分提前结清。若乙方申请部分提前结清的，部分提前结清资金将由丁方代乙方保管，不提前冲减费用及本息，借款本息、咨询费及其他费用仍按期从中冲减；若余额不足，乙方应按约定的还款方式补足差额部分。</p><p></p>
	<p><b>第六条法律及争议解决</b></p>
	...
	<p>3、本协议签订之日起至借款全部清偿之日止，甲方或乙方的下列信息如发生变更的，其应当在相关信息发生变更三日内将更新后的信息提供给丁方：本人、本人的家庭联系人及紧急联系人、工
		作单位、居住地址、住所电话、手机号码、电子邮箱、银行账户的变更。若因任何一方不及时提供上述变更信息而带来的损失或额外费用应由该方承担。</p>
