...
<link rel="stylesheet" type="text/css" media="all" href="/newcss/niceforms-default.css" />
        ...
        <div class="sidebarmenu"> <a class="menuitem submenuheader" href="">个人中心</a>
          ...
          <div class="submenu">
           ...
           <%-- <li><a href="/hhn_web/queryBankCard.do">爱定宝银行卡绑定</a></li>--%>
            </ul>
          </div>

            <a class="menuitem submenuheader" href="">爱定宝</a>
            <div class="submenu">
                <ul>
                    <li><a href="/hhn_web/accountQuery.do">爱定宝账户</a></li>
                    ...
                    <li><a href="/hhn_web/view/borrowDetails.jsp">投资记录</a></li>
                     <c:if test="${session.user.accountType==1}">
  						<li><a href="#" onclick="alert('无充值记录');return;">充值记录</a></li>
					</c:if>
					<c:if test="${session.user.accountType != 1}">
					  	<li><a href="/hhn_web/view/chargeList.jsp">充值记录</a></li>
					</c:if>
                    <li><a href="/hhn_web/view/withdrawDetails.jsp">提现记录</a></li>
                        <c:if test="${session.user.accountType==1}">
  						<li><a href="#" onclick="alert('无需绑定银行卡');return;">银行卡管理</a></li>
					</c:if>
					<c:if test="${session.user.accountType != 1}">
            ...
            <!-- 奖励记录 -->
			<a class="menuitem submenuheader" href="">邀请好友</a>
			<div class="submenu">
                <ul>
                    <li><a href="<c:url value="/inviteFriend.do"/>">邀请好友</a></li>
                    <li><a href="/include/reword-record.jsp">奖励记录</a></li>
                </ul>
			</div>
