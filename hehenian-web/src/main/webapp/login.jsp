...
--></script>
    ...
    <div style=" width:290px; float:left; padding:30px;">
      ...
      <ul>
        <li>用户名</li>
        <li>
          <input type="text" class="login_tex1" name="paramMap.email" id="email" onfocus="this.select()" value="${request.hhnUname }" style=" background:url(/images/v1/id.png) no-repeat;background-position:270px 8px;"/>
        </li>
        <li style=" margin-top:10px;">密码</li>
        <li>
          <input type="password" onfocus="this.select()" class="login_tex1" name="paramMap.password" id="password" style=" background:url(/images/v1/pass.png) no-repeat;background-position:270px 8px;"/>
        </li>
		...
		function login() {
			...
			$.post("logining.do", param, function(datas) {
				...
				if (data == 1) {
					...
					window.location.href = "/huodong.do?activityId=1";
				} else if (data == 2) {
