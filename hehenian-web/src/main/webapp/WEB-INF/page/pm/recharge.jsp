              ...
              <s:else>
                ...
                <tr>
                  <td colspan="2"><!-- 汇付天下div -->
                    ...
                    <div class="border_" id="div_chinapnr" style="display: block; ">
                      <table border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left: 10;">
                        ...
                        <tr>
                          <td><input type="radio" name="bankType" value="ICBC" id="rd_chinapnr_icbc" checked="checked" />
                            <img src="/images/banks/bank_01.png" width="100" height="28"
													style="border: none" /></td>
                          <td><input type="radio" name="bankType" value="CMB" />
                            <img src="/images/banks/bank_02.png" width="100" height="33" style="border: none" /></td>
                          <td><input type="radio" name="bankType" value="CCB" />
                            <img src="/images/banks/bank_03.png" width="100" height="33" style="border: none" /></td>
                          <td><input type="radio" name="bankType" value="ABC" />
                            <img src="/images/banks/bank_04.png" width="100" height="33" style="border: none" /></td>
                          <td><input type="radio" name="bankType" value="BOC" />
                            <img src="/images/banks/bank_05.png" width="100" height="33" style="border: none" /></td>
                        </tr>
                        <tr>
                          <td><input type="radio" name="bankType" value="SPDB" />
                            <img src="/images/banks/bank_06.png" width="100" height="33" style="border: none" /></td>
                          <td><input type="radio" name="bankType" value="SDB" />
                            <img src="/images/banks/bank_07.png" width="100" height="33" style="border: none" /></td>
                          <td><input type="radio" name="bankType" value="CIB" />
                            <img src="/images/banks/bank_08.png" width="100" height="33" style="border: none" /></td>
                          <!--
												<td><input type="radio" name="bankType" value="BOBJ" /> <img src="images/banks/bank_09.png" width="100" height="33" style="border: none" />
												</td>-->
                          <td><input type="radio" name="bankType" value="CEB" />
                            <img src="/images/banks/bank_10.png" width="100" height="33" style="border: none" /></td>
                          <td><input type="radio" name="bankType" value="BOCOM" />
                            <img src="/images/banks/bank_11.png" width="100" height="33" style="border: none" /></td>
                        </tr>
                        <tr>
                          <td><input type="radio" name="bankType" value="CMBC" />
                            <img src="/images/banks/bank_12.png" width="100" height="33" style="border: none" /></td>
                          <td><input type="radio" name="bankType" value="PSBC" />
                            <img src="/images/banks/bank_16.png" width="100" height="33" style="border: none" /></td>
                          <td><input type="radio" name="bankType" value="BOS" />
                            <img src="/images/banks/bank_19.png" width="100" height="33" style="border: none" /></td>
                        </tr>
                        <tr>
                          <td height="10"></td>
                          <td height="10"></td>
