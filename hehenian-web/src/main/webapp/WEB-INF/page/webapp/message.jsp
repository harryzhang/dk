  ...
  <div id="container">
    <div class="content">
      ...
      <div class="one-half-responsive" style=" height:450px; text-align:center; padding-top:150px;">
        ...
        <p style=" padding:20px 20px 0px 20px;"><span>5秒后自动跳转到首页，<a href="/webapp/webapp-index.do">您也可以点击立即跳转>></a></span></p>
      </div>
    </div>
  </div>
</div>
...
<script>
setTimeout(function(){window.location.href="/webapp/webapp-index.do"},5000);
</script>
<script>
