              ...
              <div class="toggle-content">
                <ul>
                  ...
                  <div class="chart_buttom" style=" margin-top:0px; margin-bottom:8px;">
                    <s:if test="%{#finance.borrowStatus == 2}"> <a href="financeDetail.do?id=${finance.id}" class="button-big button-green">立即投资</a> </s:if>
                    <s:elseif test="%{#finance.borrowStatus == 3}"> <a href="financeDetail.do?id=${finance.id}" class="button-big button-red">满标</a> </s:elseif>
                    <s:elseif test="%{#finance.borrowStatus == 4}"> <a href="financeDetail.do?id=${finance.id}" class="button-big button-dark">还款中</a> </s:elseif>
                    <s:elseif test="%{#finance.borrowStatus == 5}"> <a href="financeDetail.do?id=${finance.id}" class="button-big button-dark">已还完</a> </s:elseif>
                  </div>
                </ul>
              </div>
            </div>
