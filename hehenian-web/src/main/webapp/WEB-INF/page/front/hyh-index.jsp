...
<div class="center" style=" overflow:hidden; margin-bottom:20px;" >
  <div class="mjd_tzlc_all">
    <ul>
      <li class="tzlc" onclick="javascript:window.location.href='#'">花样会专区</li>
    </ul>
  </div>
  <!--导航图-->
  <div class="promoWD">
    <div id="main_promo">
      <div id="slides">
        <div class="slide"><a><img src="images/hyh1.jpg" /></a></div>
        <div class="slide"><a><img src="images/hyh2.jpg" ></a></div>
      </div>
    </div>
    <div id="dots">
      <ul>
