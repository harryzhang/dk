  ...
  <div class="user-center">
    ...
    <div class="user-right" style=" height:553px;">
      ...
      <div class="tzjl_cgtz_box"  style=" width:100%">
        <table width="882" border="0" cellpadding="0" cellspacing="1" bgcolor="#e5e5e5" class="hhzx_syjl">
          <tr height="60">
            <td colspan="8" bgcolor="#ffffff"><span style="float: left;margin-left: -25px; margin-right:130px;"><span>最近7天：（<i style="color: red">${map.weeks }</i>）</span> <span >1个月（<i style="color: red">${map.months1
              }</i>）</span> <span >2个月（<i style="color: red">${map.months2 }</i>）</span> <span >3个月（<i style="color: red">${map.months3 }</i>）</span></span>
              <form action="queryFontFundrecordFreeze.do" method="post" id="form" style="float: left;">
      ...
      <div class="mjd_fy_all" align="center">
        <p>
          <shove:page curPage="${pageBean.pageNum}" showPageCount="6" pageSize="${pageBean.pageSize }" theme="number" totalCount="${pageBean.totalNum}" url="queryFontFundrecordFreeze.do">
