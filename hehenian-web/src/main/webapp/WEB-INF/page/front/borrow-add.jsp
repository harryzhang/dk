	...
	<form id="form" action="addBorrow.do" method="post">
		<div class="center">
			<div class="wytz_center">
				<div class="fbjk_all">
					<h5>
						<strong> 发布借款 </strong> <span> <b> * </b> 为必填项，所有资料均会严格保密。 </span>
					</h5>
					<div class="rmainbox" style="margin-top: -20px;">
						...
						<div class="tab">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									<td width="90" align="right">借款标题：</td>
									<td><input name="paramMap.title" type="text" class="inp280" maxlength="12" value="${paramMap.title}" /> <span class="fred" style="color:#ff0000;"><s:fielderror
								...
								<tr height="10"></tr>
								<tr>
									<td align="right" width="90"><span>借款总额：</span>
									</td>
									<td><input type="text" id="amount" name="paramMap.amount" class="inp100x" value="${paramMap.amount}" />元<span style="color:#ff0000;"> <span id="amountIp"
							...
							<table width="955" border="0">
								<tr>
									<td align="right" width="90"><span>担保机构：</span>
									</td>
							...
							<table width="955" border="0">
								...
								<tr height="10"></tr>
								<tr>
									<td><span style="float:left; margin-top:4px;">验证码：</span><input type="text" style=" width:90px; float:left;" class="inp100x" name="paramMap.code" id="code" /> <img src=""
										title="点击更换验证码" style="cursor: pointer;margin-top: 2px;" id="codeNum" width="56" height="25" onclick="javascript:switchCode()" /> <span style="color:#ff0000;"><s:fielderror
								...
								<tr height="20"></tr>
								<td><input type="button" value="发布借款" id="bcbtn" class="fbjk_aniu" />
								</td>
								</tr>
								<tr height="10"></tr>
							</table>
