		...
		<div class="login_center" style="width:1000px; background:#f8f8f8 url(images/hhnimages/hhn/login_bg1.png) 0 20px no-repeat; margin:0 auto;">
			<div class="login_center_left">
				<table width="500" border="0" cellspacing="0" cellpadding="0" style="margin-left:130px;">
					...
					<tr height="5"></tr>
					<tr>
						<td colspan="2"><input disabled type="text" class="login_tex1" name="paramMap.userName" id="userName" value="<s:property value='#request.userName'/>"  /><br> <span style="color: red;margin-left: 32px;" id="s_userName"
								class="formtips"></span>
						</td>
					</tr>
					<tr height="5"></tr>
					<tr>
						<td><strong>*</strong><b>交易密码：</b></td>
						<td>&nbsp;</td>
					</tr>
					<tr height="5"></tr>
					<tr>
					...
					<tr height="5"></tr>
					<tr>
						<td><strong>*</strong><b>确认交易密码：</b></td>
						<td>&nbsp;</td>
					</tr>
					<tr height="5"></tr>
					<tr>
					...
					<tr height="5"></tr>
					<tr>
						<td colspan="2"><input disabled type="text" class="login_tex1" name="paramMap.telephone" id="telephone" value="<s:property value='#request.telephone'/>" /> <%--                    <a href="javascript:void()" onclick="getTelephoneCode()" id="ida" disable="no"><strong id="message">获取验证码</strong> </a>--%>
					...
					<tr height="5"></tr>--%>
					<tr>
						<td colspan="2"><input type="hidden" class="login_tex1" name="paramMap.refferee" id="refferee" value="<s:property value='#request.paramMap.userId'/>" /><br> <span style="color: red;margin-left: 32px;" id="s_refferee"
								class="formtips">
						</td>
					</tr>
					<tr height="20"></tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;第五十一条 本协议签订地为中国深圳市。因本协议所引起的会员与合和年在线的任何纠纷或争议，首先应友好协商解决，协商不成的，会员在此完全同意将纠纷或争议提交深圳市彩付宝网络技术公司所在地有管辖权的人民法院诉讼解决。
				...
				<table width="500" border="0" cellspacing="0" cellpadding="0" style="margin-left:150px;margin-top: 20px;">
					<tr>
						<td><input type="button" id="btn_register" value="保存" /></td>
					</tr>
					<tr height="20"></tr>
				</table>
			</div>
