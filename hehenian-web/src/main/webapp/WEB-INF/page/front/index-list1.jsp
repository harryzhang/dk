...
<div class="center_banner">
    ...
    <div id="flashBg" style="background-color: rgb(11, 11, 11); height:300px; overflow:hidden; border-top:1px solid #e4e4e4;border-bottom:1px solid #e4e4e4 ">
        <div style=" width:1170px; margin:0px auto;">
            <!--登陆窗口浮动层-->
            <div style=" height:300px; width:400px;background-color:rgba(255,155,60,0.9);position:absolute; z-index:9999; margin-left:770px; color:#FFF">
                <!--登陆窗口-->
                <s:if test="%{#session.user==null}">
                    <div  style="padding-left:40px; padding-top:20px; font-size:25px;">合和年在线收益率</div>
                    <div   style="padding:10px 0 10px 40px; font-size: 25px;">
                        最高可达<span style="font-size:60px;font-family: 'Arial';">14%</span>
                    </div>
                    <div  style=" margin-left:40px; ">
                        <input type="button" onclick="window.location.href='/account/reg.do'" value="免费注册" style=" width:318px; height:40px; border:0px; background:#F60; font-size:24px;color:#FFF; margin-left:0px;cursor: pointer;"/>
                    </div>
                    <div style="padding-left:40px; font-size:12px; margin-top:20px; letter-spacing: 0.6px; ">
                        <font size="+1"  style="font-family: 'Arial';">￥100</font>起投，花样年集团承诺逾期回购<br />
                        <font size="+1" style="font-family: 'Arial';">100%</font>保障投资者资金安全</div>
                    <div  style=" margin-left:25px; margin-top:10px; font-size:12px; width:328px;text-align:right;">已有账号，
                        <a  href="<c:url value="/account/login-index.do"/>" style=" color:#06C">立即登录</a></div>
                </s:if>
                <s:else>
                <div  >
                    <div  style="padding-left:40px; padding-top:20px; font-size:25px;">合和年在线收益率</div>
                    ...
                    <div  style=" margin-left:40px; margin-top:0px; line-height:26px; ">
                    ...
                    <div  style=" margin-left:40px; margin-top:10px; font-size:12px; color:#FFF; text-align:right;"><span><a href="/rechargeInit.do" style=" display: block; float:left; width:150px; height:40px; background:#F60; text-align:center; border:none; color:#fff; cursor:pointer; font-size:24px;color:#FFF; line-height:40px; ">充值 </a></span> <a href="/withdrawLoad.do" style=" width:150px; height:40px; background:#6baf00;text-align:center; border:none; color:#fff; cursor:pointer; margin-left:15px;display: block; float:left; line-height:40px;font-size:24px;">提现</a></div>
                    </s:else>
                </div>
            </div>
            <!--首页大图-->
            <div id="flashLine">
                <div id="flash" style=" height:300px;">
                    <a href="/hhn_web/termFinance.do" id="flash1" name="#b52a4b" style="display: block;">
                        <img src="/images/zd/12.jpg" width="1170" height="350">
                    </a>
                    <a href="#" id="flash2" name="#1082e3" style="display: block;">
                        <img src="/images/zd/13.jpg" width="1170" height="350">
                    </a>
                    <a href="#" id="flash3" name="#dddddd" style="display: none;">
                        <img src="images/zd/14.jpg" width="1170" height="350">
                    </a>
        ...
        <div style=" margin-top:40px; padding:0px 50px 0px 50px">
            ...
            <div class="center_one_left_db">
                <s:if test="#request.mapList.size>0">
                    <s:iterator value="#request.mapList" var="finance" end="2" begin="0">
...
<div style=" width:1170px; margin:20px auto 20px auto;  border:1px solid #e3e3e3 ; overflow:hidden" class="bottom_link">
    <div  style=" float:left;padding:10px 30px; background:#F2F2F2">合作伙伴</div>
    <div  class="bottom_link_all" style=" float:left; width:990px;padding-left:30px ; ">
        <ul>
            <li>中国农业银行</li>
            <li>中国建设银行</li>
            <li style=" float:left ; padding:0px 7px; ">上海汇付数据服务有限公司</li>
            <li><a href="http://wdttd.com" target="_blank">财富中文网</a></li>
            <li><a href="http://www.p2pjop.com/" target="_blank">网贷帝国</a></li>
            <li><a href="http://www.dianpifa.com/" target="_blank">P2P理财网</a></li>
            <li><a href="http://www.wdzx.com/" target="_blank">网贷中心</a></li>
            <li><a href="http://www.wangdaizhijia.com/" target="_blank">网贷之家</a></li>
            <li><a href="http://www.xwedai.com/" target="_blank">小微e贷</a></li>
