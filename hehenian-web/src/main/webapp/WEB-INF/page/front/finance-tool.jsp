...
<%--				<li>手机号查询</li>--%>
			...
			<div class="tzlc_gjx_one" style="display:block;">
				<div class="tzlc_gjx_one_a">
					<span>借款金额：</span> <input id="borrowSum" type="text" class="inp100x" /> <span>年利率：</span> <input id="yearRate" type="text" class="inp100x" />% <span>借款期限：</span> <input
						id="borrowTime" type="text" class="inp100x" /><span id="timeType">月</span> <span>还款方式：</span> <select id="repayWay" name="select">
...
<%--						<option value="2">一次还本付</option>--%>
					</select> <input type="button" onclick="javascript:rateCalculate();" value="计算" />
				</div>
				<div class="gjxtab">
					<span style="color: #e94718; float: none;padding-left: 18px" class="formtips" id="show_error"></span> <span id="showPayTable"></span>
				</div>
				<div class="tzlc_gjx_one_b">
					<span>每月将偿还：</span> <strong id="aa">元</strong> <span>月利率：</span> <strong id="bb">%</strong> <span>还款本息总额：</span> <strong id="cc">元</strong>
				</div>
			</div>
			<div class="lcmain">
				<div class="lcmain_l" style="float:none; margin-left:0px; width:auto; padding:10px 25px 50px;">
					<div class="box">
						...
						<div class="tzlc_gjx_one">
							<div class="tzlc_gjx_one_a">
								<p>
									<span style="color:#666;">在下面输入框中输入您要查询的IP地址,点击查询按钮即可查询该IP所在地区。</span>
								</p>
								<br/><br/>
										<p>
											<span>IP地址：</span> <input type="text" class="inp280" id="ipAddress" /> <input type="button" onclick="queryIP();" value="查询" />
										</p>
							</div>
							<div class="tzlc_gjx_one_b">
								<p class="gjjg">
									<span>查询结果：</span> <span id="queryIPInfo" style="color: #e94718;">暂无查询信息</span>
								</p>
							</div>
						...
						<div class="tzlc_gjx_one">
							<div class="tzlc_gjx_one_a">
								<P >
									<span>请输入手机号码：</span> <input type="text" class="inp280" id="phoneNum" /> <input type="button" onclick="javascript:queryPhone();" value="查询" />
								</P>
							</div>
							<div class="tzlc_gjx_one_b">
								<p class="gjjg">
									<span>查询结果：</span> <span id="queryPhoneInfo" style="color: #e94718;">暂无查询信息</span>
								</p>
							</div>
						</div>
					</div>
