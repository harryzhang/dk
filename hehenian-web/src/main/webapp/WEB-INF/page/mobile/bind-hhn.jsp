...
<div class="wrap" id="wrap" style="display:none;">
    ...
    <form action="webapp-colourlife-bind-hhnuser.do" id="form">
      <input type="hidden" value="userlogin" name="paramMap.pageId" />
          <div class="input-item login-line"><input type="text" name="paramMap.email" class="username" placeholder = "请输入合和年登录用户名" validate="true" rule="{type:'username',empty:false,length:'2-15',disabled:''}" tips="{username:'请输入正确的合和年登录用户名',empty:'请输入合和年登录用户名'}"></div>
