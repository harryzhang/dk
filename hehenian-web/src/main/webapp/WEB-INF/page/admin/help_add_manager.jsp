...
<html>
	...
	<body>
		<form id="addHelpManager" name="addHelpManager" action="addHelpManager.do" method="post">
			<div id="right">
					...
					<div style="width: auto; background-color: #FFF; padding: 10px;">
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							...
							<tr>
								...
								<td align="left" class="f66">
									<s:textfield name="paramMap.publisher" cssClass="in_text_2" cssStyle="width:666px" theme="simple" />
							...
							<tr>
								...
								<td align="left" class="f66">
									<s:textfield name="paramMap.publishTime" cssClass="in_text_2" cssStyle="width:666px" theme="simple" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',readOnly:'readOnly'})" />
