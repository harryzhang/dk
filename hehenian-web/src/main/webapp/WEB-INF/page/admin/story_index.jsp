	...
	<head>
		...
		<script type="text/javascript">
			...
			function initListInfo(praData){							    
		 		$.shovePost("querySuccessStoryListPage.do",praData,initCallBack);
		 	}
			...
			function dels(){
	 			...
	 			window.location.href= "deleteSuccessStory.do?id="+ids;
		 	}
		 	...
		 	function del(id){
	 			...
	 			window.location.href= "deleteSuccessStory.do?id="+id;
		 	}
		 	...
		 	function checkAll(e){
   			...
   			//成功故事预览  houli
		 	function preview(id){
		 	  var url = "previewSuccessStoryInit.do?id="+id;
              ShowIframe("成功故事详情显示",url,600,450);
