...
<html>
		  ...
		  $(function(){
		      //提交表单
				...
				var stIdArray = [];
	 			...
	 			param["tb_name"] = $("#tb_name").val();//标种类型
	 			param["tb_nid"] = nid;//标识名
				...
				$.post("validateAddShoveType.do",param,function(data){
					if(data==68){
						$("#addShoveType").submit();
					}
					if(data==1){
					...
					if(data==4){
						...
						$("#borrowAmount").html(" * 最低借款额度不能大于最高借款额度");
						return false;
					}else{
						$("#borrowAmount").html(" *");
					} 
					...
					if(data==60){
						...
						$("#locan_fee").html(" * 请正确填写借款限定期限的借款费");
						return false;
					}else{
						$("#locan_fee").html(" *");
					}
	...
	<body>
		<form id="addShoveType" name="addShoveType" action="addShoveTypeInfo.do" method="post">
			<div id="right">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="100" height="28"  class="main_alll_h2">
									<a href="addShoveTypeInit.do">添加标种类型</a>
								</td>
								<td>
									&nbsp;
								</td>
						...
						<table width="800" border="0" cellspacing="1" cellpadding="3"  align="center" >
							<tr>
								...
								<td align="left" class="f66">
									<s:textfield id="tb_name" name="paramMap.name" cssClass="in_text_250" theme="simple"/>
									<span class="require-field" id="name">*<s:fielderror fieldName="paramMap.name"></s:fielderror></span>
								</td>
							</tr>
							<tr>
								<td style="width: 100px; height: 30px;" align="right"
								...
								<td align="left" class="f66">
									<s:textfield id="tb_nid" name="paramMap.nid" cssClass="in_text_250" theme="simple"/>
									<span class="require-field" id="nid">*<s:fielderror fieldName="paramMap.nid"></s:fielderror></span>
								</td>
							</tr>
								<tr>
								<td style="width: 100px; height: 30px;" align="right"
							...
							<tr>
								...
								<td align="left" class="f66">
									<input type="radio" name="paramMap_status" value="1" checked="checked"/>开启
									<input type="radio" name="paramMap_status" value="2"/>关闭
								</td>
							</tr>
								...
								<td align="left" class="f66">
									<s:iterator value="#request.mapTypeList" var="mapType" status="st">
										<input type="radio" name="paramMap_amount_type" value="${mapType.id}" 
											<s:if test="#mapType.id == 1">checked="checked"</s:if>
										/>${mapType.title }&nbsp;&nbsp;
									</s:iterator>
							...
							<tr>
								...
								<td align="left" class="f66">
									<input type="radio" name="paramMap_award_status" value="1" checked="checked" />开启 
									<input type="radio" name="paramMap_award_status" value="2" />关闭
								</td>
							</tr>
							<tr>
								<td style="width: 120px; height: 30px;" align="right"
								...
								<s:if test="%{'flow' eq paramMap.nid}">
									<input type="radio" name="paramMap_password_status" value="2"  checked="checked" />关闭
								</s:if>
								<s:else>
									<input type="radio" name="paramMap_password_status" value="1" />开启 
									<input type="radio" name="paramMap_password_status" value="2" checked="checked" />关闭
								 </s:else>
								</td>
							</tr>
							...
							<tr>
								...
								<td align="left" class="f66">
									<input type="radio" name="paramMap_verify_auto_status" value="1" />开启 
									<input type="radio" name="paramMap_verify_auto_status" value="2" checked="checked" />关闭
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<s:else>
									...
									<input type="checkbox" name="paramMapStyles" value="${map.id }"
									 ...
									 <span class="require-field" id="style_id">*<s:fielderror fieldName="#map.title"></s:fielderror></span>
								</s:else>
								</td>
							</tr>
							<tr>
								...
								<td align="left" class="f66">
									<s:if test="%{'flow' eq paramMap.nid}">
										<input type="radio" name="paramMap_subscribe_status" value="1"  checked="checked" />开启 
									</s:if>
									<s:else>
										<input type="radio" name="paramMap_subscribe_status" value="2"  checked="checked" />关闭
									</s:else>
								</td>
							</tr>
							<s:if test="%{'flow' eq paramMap.nid}">
