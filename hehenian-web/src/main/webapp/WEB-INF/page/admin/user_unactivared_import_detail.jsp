...
<html>
	...
	<body>
	<form id="importForm" action="importInfo.do" enctype="multipart/form-data" method="post">
			<div id="right"
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							...
							<tr>
								<td style="width: auto; height: 25px;" align="center"
									class="blue12" colspan="2">
									<a href="../templete/20130813095010.xls" style="color: blue;">下载表格：《客户注册信息》</a>
								</td>
							</tr>
							...
							<tr>
								<td style="width: auto; height: 25px;" align="center"
									...
									<span style="color: red;"><br/><s:fielderror name="userFile"></s:fielderror>
