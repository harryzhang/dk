	...
	<head>
		...
		<script type="text/javascript">
			...
			function initListInfo(param){
		 		$.shovePost("queryIndexRollImgInfo.do",param,initCallBack);
		 	}
			...
			function dels(){
	 			...
	 			window.location.href= "deleteIndexRollImg.do?commonId=" + ids;
		 	}
		 	...
		 	function del(id){
	 			...
	 			window.location.href= "deleteIndexRollImg.do?commonId="+id;
		 	}
