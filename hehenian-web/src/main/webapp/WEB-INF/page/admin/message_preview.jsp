			...
			<div style="padding: 15px 10px 0px 10px;text-align: center;" >
				...
				<div style="width: auto; background-color: #FFF; padding: 10px;">
					<table width="100%" border="0" cellspacing="1" cellpadding="3">
						...
						<tr>
							<td style="height: 25px;" align="right" class="blue12">&nbsp;</td>
							<td align="left" class="f66">${paramMap.content }</td>
						</tr>
						<tr></tr>
						<tr></tr>
						<tr></tr>
						...
						<tr>
							...
							<td>
								<button id="btn_save" onclick="closeWin();" style="background-image: url('../images/admin/btn_queding.jpg'); width: 70px; border: 0; height: 26px;margin-left: -90px;"></button> &nbsp;</td>
						</tr>
					</table>
					<br />
				</div>
