...
<html>
		...
		$("#bt_search1").click(function(){
			var stIdArray = [];
		 	...
		 	var ids = stIdArray.join(",");
                  window.location.href=encodeURI(encodeURI("exportBringBorrow.do?ids="+ids));
             });
	...
	function initListInfo(praData) {
		$.post("queryBringList.do", praData, initCallBack);
	}
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="120" height="28" class="main_alll_h2">
								<a href="queryBringListIndex.do">撮合借款管理列表</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
								...
								<tr>
									...
									<td class="f66" align="left" height="36px">
										...
										<select id="source" name="source">
											<option value="" ${paramMap.source eq "" ? "selected=selected" : "" }>
												请选择
											</option>
