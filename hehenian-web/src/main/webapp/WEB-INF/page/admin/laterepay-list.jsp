			...
			<s:else>
				...
				<s:iterator value="pageBean.page" var="bean" status="s">
					<tr class="gvItem">
						...
						<td>${bean.realName}</td>
						<td><a href="${basePath}/financeDetail.do?id=${bean.borrowId}" target="_blank">${bean.borrowTitle}</a>
						</td>
						...
						<td><s:if test="#bean.borrowWay == 1">
							...
							业主贷
							</s:elseif> <s:elseif test="#bean.borrowWay == 4">
							实地考察借款
							</s:elseif> <s:elseif test="#bean.borrowWay == 5">
							机构担保借款
							</s:elseif>
						</td>
						...
						<td><s:if test="#bean.isWebRepay==1">
							   否
							</s:if> <s:elseif test="#bean.isWebRepay==2">是</s:elseif>
						</td>
						...
						<td><a href="repaymentDetail.do?id=${bean.id}">查看</a>
						</td>
					</tr>
				</s:iterator>
			</s:else>
