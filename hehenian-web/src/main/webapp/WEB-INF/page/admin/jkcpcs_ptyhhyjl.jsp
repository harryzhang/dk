...
<script type="text/javascript">
  ...
  function Costfriend(){
      ...
      if((/^\d{1,3}(\.\d{1,2})?$/.test(number))){
          $.post("updateCostManager.do","number="+number+"&typeId=3",function(data){
           if(data==1){
              alert("修改成功");
           }else if(data==2){
              alert("修改失败");
...
<table width="100%" border="0" cellspacing="1" cellpadding="3">
							<tr>
								...
								<td align="left" class="f66">
									<s:textfield id="tb_number" name="paramMap.number"
										cssClass="in_text_250" theme="simple"></s:textfield>元
							...
							<tr>
								...
								<td align="left" class="f66">
									<span style="color: red;">注：普通用户推荐好友奖励（每推荐一个好友并加入vip得到此奖励）</span>
								</td>
							</tr>	
