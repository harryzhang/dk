					...
					<div id="showcontent" style="width: auto; background-color: #FFF; padding: 10px;">
						...
						<td id="secodetble" style="width: 500px;" >
						  <table  border="0" cellspacing="1" cellpadding="3" >
							...
							<td colspan="2">
						    <table>
							 <tr><td class="white12" height="20" bgcolor="#8594A9" align="center" width="120px">
							<span style="cursor: pointer;" onclick="javascript:window.location.href='queryUserManageBaseInfoinnerU.do?i=${UserMsgmap.id}';">个人基本信息</span></td>
							<td>&nbsp;</td><td class="white12" width="120px" height="20" bgcolor="#CC0000" align="center">
