		...
		<div style="padding: 15px 10px 0px 10px;">
			<div>
				<table border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="100" height="28" class="xxk_all_a"><a href="backBuyInit.do">待回购借款</a></td>
						<td width="2">&nbsp;</td>
						<td width="100" id="today" height="28" class="main_alll_h2"><a href="hasBackBuyInit.do">已回购借款</a></td>
					...
					<tbody>
						<tr>
							<td class="f66" align="left" height="36px">用户名: <input id="userName" value="" maxlength="20" />&nbsp;&nbsp; 借款类型： <s:select id="borrowWay"
									list="#{-1:'--请选择--',1:'薪金贷',2:'生意贷',3:'业主贷'}"></s:select>&nbsp;&nbsp; <input id="search" type="button" value="搜索" name="search" /> <%--									<input id="excel" type="button"--%>
								<%--								value="导出Excel" name="excel" />--%></td>
						</tr>
					</tbody>
				</table>
...
<%--				});--%>
	...
	function initListInfo(praData) {
		...
		$.shovePost("hasBackBuyList.do", praData, initCallBack);
	}
