...
<script type="text/javascript">
	...
	function initListInfo(param) {
		...
		param["type"] = $("#type").val();
		$.shovePost("merInvestCheckList.do",$.param(param),initCallBack);
	}
			...
			<div>
				<div style="margin-bottom: 10px;">
					<table border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="100" height="28" class="main_alll_h2"><a href="merInvestCheck.do">投标对账</a>
							</td>
							<td width="2">&nbsp;</td>
							<td width="2">&nbsp;</td>
							<td width="2">&nbsp;</td>
				...
				<div style="padding-right: 10px; padding-left: 10px; padding-bottom: 10px; width: 1120px; padding-top: 10px; background-color: #fff;">
					...
					<span id="dataInfo"> <a style="color: red;font-size: 12px;">请选择时间,交易类型</a>  </span>
				</div>
			</div>
		</div>
	</div>
