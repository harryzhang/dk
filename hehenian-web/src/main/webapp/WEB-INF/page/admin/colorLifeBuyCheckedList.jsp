...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#excel").click(function(){   
			...
			window.location.href=encodeURI(encodeURI("exportExcelBuyInfo.do?ids="+ids));
		});
								...
								<c:if test="${not empty pageBean.page}">
									...
									<c:forEach items="${pageBean.page}" var="map">
										<tr class=gvItem>
											...
											<td align="center"><fmt:formatDate value="${map.updateTime}" pattern="yyyy-MM-dd"/></td>
											<td align="center">${map.verifierName}</td>
											<td align="center">${map.statusLabel}
											</td>
										</tr>
									</c:forEach>
								</c:if>
