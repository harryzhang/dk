		...
		<div style="padding: 15px 10px 0px 10px;">
			<div>
				...
				<div
					...
					<form action="getLoan.do" method="get">
					...
					<div align="right">
						<font color="red">预期收益：${slExpectedEarnings } 元</font>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	...
	function toPage(pageNo) {
		window.location.href = "getLoan.do?loanPersonDo.realName=${loanPersonDo.realName}&loanPersonDo.mobile=${loanPersonDo.mobile}&curPage="
				+ pageNo + "&pageSize=10";
	}
	
	//受理
	function queryRecheckById(id) {
		$.jBox("iframe:loanInit.do?id=" + id, {
			title : "业务受理",
			width : 600,
			height : 580,
			top : 25,
