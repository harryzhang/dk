...
<body class="bg-3">
	...
	<section class="succ-area">
		<div class="succ-logo" style="background-image: url(http://static.hehenian.com/m/img/succ-phone-logo.png);">
		</div>
		<div class="anch-launch">
			<a href="http://m.hehenian.com/login/loginout.do">
				登陆
			</a>
		</div>
	</section>
