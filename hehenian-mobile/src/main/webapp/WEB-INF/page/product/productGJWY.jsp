...
<body class="bg-2">
	<header class="top-bar">
		...
		<a href="http://m.hehenian.com/login/index.do" class="staff-entry">
			+族宝
		</a>
		</c:if>
		<c:if test="${ not empty loginId and loginId gt 0}">
	...
	<article>
		<div class="banner">
			<ul >
				<li><a href="http://m.hehenian.com/product/lottery.do"><img src="http://static.hehenian.com/m/activity/img/rotate/banner.png" alt=""></a></li>
				<li><a href="#"><img src="http://static.hehenian.com/m/img/banner/2.jpg" alt=""></a></li>
				<li><a href="#"><img src="http://static.hehenian.com/m/img/banner/3.jpg" alt=""></a></li>
				<li><a href="#"><img src="http://static.hehenian.com/m/img/banner/1.jpg" alt=""></a></li>
			</ul>
		</div>
	...
	<article class="product-bar">
		<p class="product-name">+薪宝·12-M</p>
		<p class="product-feature">收益稳健，安全快捷</p>
		<a href="http://m.hehenian.com/product/detail.do?pid=8">
		<section class="product-detail">
			<p>预期年化收益率</p>
			<p class="pro-num">10%</p>
			<a href="http://m.hehenian.com/product/detail.do?pid=8" class="pro-more">
				查看详情 >>
			</a>
		</section>
		</a>
		<a href="http://m.hehenian.com/finance/prepay.do?pid=8">
			<div class="pro-bn">
				立即购买
			</div>
		</a>
	...
	<article class="product-bar">
		...
		<p class="product-name">+多宝</p>
		<p class="product-feature">预存一定金额，赠送一年物业费</p>
		<a href ="http://m.hehenian.com/product/detail.do?pid=14" >
		
			<section class="product-detail2">
			</section>
			</a>
		<a href="http://m.hehenian.com/product/queryDefaultOffset.do?pid=14">
			<div class="pro-bn">
				立即购买
			</div>
		</a>
	...
	<article class="product-bar">
		<p class="product-name">+車宝</p>
		<p class="product-feature">预存一定金额，赠送一年停车费</p>
		<a href="http://m.hehenian.com/product/detail.do?pid=15">
			<section class="product-detail3">
			</section>
		</a>
		<a href="http://m.hehenian.com/product/queryDefaultOffset.do?pid=15">
			<div class="pro-bn">
				立即购买
			</div>
		</a>
