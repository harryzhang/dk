...
<script type="text/javascript" src="${basePath}/js/loan/community.js?version=2"></script>
			      ...
			      <table border="0">
			        <tr>
			          <td class="tdfont">查询条件:
			          	<input type="text" size="14" id="searchStr" name="searchStr" placeholder="事业部名称" >
			          </td>
			          <td>
			          	<input type="text" size="14" id="searchCuserName" name="searchCuserName" placeholder="姓名" >
			          </td>
			          <td >
