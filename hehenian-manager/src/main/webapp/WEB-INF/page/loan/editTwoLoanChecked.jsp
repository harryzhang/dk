...
<!-- 内容 -->
<div>
		<form id="editTwoLoanChecked" method="post" style="padding:2px;"> 
		<div class="topbar_select" style="margin-top: 40px;">
		<div class="titlepart">二审结果： </div>
			<div class="bodypart">
	...
	<div class="bodypart">
	   <c:if test="${!empty loanCheckOne && loanCheckOne eq '1'}">
	   		<a class="l-btn l_btn_size"  data-options="disabled:true" style="float:left;"
			plain="true" icon="icon-save" href="javascript:void(0)"  ><i class="fa fa-check green"></i>&nbsp;确定</a>
	   </c:if>
	   <c:if test="${empty loanCheckOne}">
	...
	if(checkrlt=="1")
		{
			var opt = $.messager.confirm("审核", '请确认要提交', function(r){
				if(r==true)
					{
					save_loan_checked('#twoCheckedDiv','#editTwoLoanChecked');
					}
			});
			return false;
		}else{
