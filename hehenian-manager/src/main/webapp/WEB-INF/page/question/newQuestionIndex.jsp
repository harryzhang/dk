...
<div class="tabelMod">
	...
	<div style="display:inline-block">
		<label>创建时间：从</label>
		<input id="minCreateTime" type="text" style="width:100px;" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',lang:'zh-cn'})"/>
		到
		<input id="maxCreateTime" type="text" style="width:100px;" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',lang:'zh-cn'})"/>
		
		<label>修改时间：从</label>
		<input id="minModifyTime" type="text" style="width:100px;" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',lang:'zh-cn'})"/>
		到
		<input id="maxModifyTime" type="text" style="width:100px;" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',lang:'zh-cn'})"/>
	</div>
</div>
...
<div class="btnBox">
	...
	<div id="addQuestionBtn" style="cursor: hand"></div>
	<div id="initQuestionBtn" style="cursor: hand"></div>
	<div id="resetQuestionBtn" style="cursor: hand"></div>
</div>
