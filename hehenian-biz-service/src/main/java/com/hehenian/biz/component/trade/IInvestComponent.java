...
public interface IInvestComponent {
     ...
     */
    void updateHasAmount(InvestDo newInvestDo);
     ...
     */
    void updateRepayStatusById(long investId);
     ...
     */
    List<InvestDo> queryByIds(List<Long> idList);
