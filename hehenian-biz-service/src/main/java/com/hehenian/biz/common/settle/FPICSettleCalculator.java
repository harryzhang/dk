 ...
 * @Title: FPCISettleCalculator.java
 * @Description: TODO
 * @author: liuzgmf
 * @date 2015年1月7日 上午9:40:06
...
/**
 * 平息结算方式，Fixed principal interest is calculated（ 固定本金计算利息）
 * 
 * @author: liuzgmf
 * @date 2015年1月7日 上午9:40:06
 */
public class FPICSettleCalculator extends SettleCalculator {
